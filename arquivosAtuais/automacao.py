...
# PASSO 3: LAÇO DE REPETIÇÃO DA PLANILHA
# ---------------------------------------------------------------------------
# Linha para comeca e linha para terminar mais um (ou seja, vai da linha 500 até a linha 600)
# for linha in range(500, 601):
# for linha in range(601, 1145):
...
# for linha in range(117,218):
# for linha in range(218,319):
# for linha in range(323,500):
# for linha in range(1145,1322):
